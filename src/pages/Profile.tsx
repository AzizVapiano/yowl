...
import { FiEdit2, FiMessageCircle, FiHeart, FiShare2, FiTrash2 } from 'react-icons/fi';
        ...
        >
          {!isEditing ? (
            <div className="relative">
              ...
              <p className="text-gray-700 whitespace-pre-wrap">{profile.bio || 'Aucune biographie'}</p>
            </div>
          ) : (
