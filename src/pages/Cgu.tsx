      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Dernière mise à jour : {lastUpdate}</p> </div>
          <div className="mb-6">
            <p className="text-lg">
              ...
              présentes conditions d'utilisation.  </p> </div>
              ...
              <div key={index} className="border rounded-lg">
                <button
                  ...
                  {section.isOpen ? (
                    ...
                    <ChevronDown className="h-5 w-5 text-gray-500" /> )} </button> 
                {section.isOpen && (
          ...
          <div className="mt-8 text-center space-y-6">
            <p className="text-gray-600">
              ...
              sécurisée et agréable pour tous. </p>
            <button
              onClick={() => navigate('/')}
              ...
              <span>Retour à l'accueil</span> </button> </div></div> </div></div> );};
